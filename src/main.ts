...
const { packet, highlight, pulse, updateStatus, statusPill, slideOut } =
  withTracing({
    packet: _packet,
...
// Wait a frame for layout to settle, then draw arrows + animate
requestAnimationFrame(() => {
  ...
  tl.to({}, { duration: 1.0 }); // pause to show prompt
